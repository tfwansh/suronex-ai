  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="pt-4 sm:pt-6 border-t border-white/10 shrink-0"
      >
            ...
            {socialLinks.map((social, i) => {
              ...
              return (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="group relative w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-white/5 backdrop-blur-sm border border-white/10 flex items-center justify-center transition-all duration-300 hover:border-white/20 hover:bg-white/10"
