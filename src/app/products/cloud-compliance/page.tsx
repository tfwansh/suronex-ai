// app/products/cloud-compliance/page.tsx
"use client"
                  ...
                  <div className="relative h-full flex items-center justify-center p-12">
                    <div className="text-center">
                      ...
                      <div className="text-gray-400 max-w-md">
                        Cloud Compliance Platform Dashboard - Unified view of compliance status, risk metrics, and policy management
                      </div>
                    </div>
  ...
  return (
    <section ref={ref} className="py-32 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-bold mb-6">Cloud Compliance Business Impact</h2>
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Proven results across enterprise Cloud Compliance programs
          </p>
        </motion.div>
...
function CoreCapabilitiesShowcase() {
  ...
  const capabilities = [
    {
      title: "Cloud Security Policy Management",
      icon: FileText,
    ...
    {
      title: "Cloud Vendor & Third-Party Risk Assessment",
      icon: Network,
    ...
    {
      title: "End-to-End Cloud Compliance Management",
      icon: Shield,
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Comprehensive Cloud Compliance platform for cloud infrastructure security and compliance
          </p>
        </motion.div>
  ...
  return (
    <section ref={ref} className="py-32 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-bold mb-6">
            Cloud Security Risk Management & Assessment Compliance Assessment
          </h2>
          <p className="text-2xl text-gray-400 max-w-3xl mx-auto">
  ...
  const benefits = [
    {
      ...
      items: [
        { title: "Process Automation", desc: "Automate routine Cloud Compliance tasks and workflows to improve efficiency" },
        { title: "Centralized Management", desc: "Single platform for managing all cloud compliance and security activities" },
        { title: "Real-Time Visibility", desc: "Real-time dashboards and reporting for informed decision-making" },
        { title: "Resource Optimization", desc: "Optimize allocation of resources across Cloud Compliance activities" }
      ]
    },
    {
      ...
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-bold mb-8">
            Ready to transform your Cloud Compliance program?
          </h2>
          <p className="text-2xl text-gray-400 mb-12">
            See how Suronex streamlines cloud security, reduces risk, and ensures compliance
          </p>
