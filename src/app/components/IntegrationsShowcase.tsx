...
function IntegrationCard({ integration, index, isMobile }: { integration: typeof integrations[0]; index: number; isMobile: boolean }) {
  ...
  return (
    ...
    >
      <motion.div
        ref={cardRef}
        className={`relative bg-white/[0.02] border overflow-hidden cursor-pointer group rounded-xl sm:rounded-2xl will-change-transform ${
          isComingSoon
            ? 'border-white/5'
      ...
      >
        ...
        {/* Card content */}
        <div className={`relative p-4 sm:p-6 min-h-[180px] sm:min-h-[200px] flex flex-col items-center justify-center ${
          ...
          <motion.h3
            className={`text-xs sm:text-sm font-semibold mb-2 text-center leading-tight ${
    ...
    <section className="relative py-10 sm:py-12 md:py-14 bg-black overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        >
          ...
          <p className="text-[10px] sm:text-xs text-neutral-700 mt-5 sm:mt-6 max-w-2xl mx-auto leading-relaxed">
