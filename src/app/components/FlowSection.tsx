...
const FlowSection = () => {
    ...
    const timelineItems = [
        {
            title: "Connect",
            description: "Seamlessly integrate with AWS, Azure, GCP, and on-premises infrastructure.",
        ...
        {
            title: "Scan",
            description: "Advanced threat detection powered by AI continuously monitors your infrastructure.",
        ...
        {
            title: "Remediate",
            description: "One-click automated remediation workflows eliminate security risks instantly.",
        ...
        {
            title: "Report",
            description: "Executive dashboards and compliance reports at your fingertips.",
                                                    ...
                                                    >
                                                        ...
                                                        <ul className="space-y-2 text-neutral-300">
                                                            {[
                                                                ...
                                                                "Detailed audit trails with logging"
                                                            ].map((feature, i) => (
                                                                <motion.li
                                                                    key={i}
